...
- Пользователь может добавлять к каждом просмотренному фильму или серии сериала заметки
...
- Возможность хранить списки фильмов, сериалов, аниме, и мультипликаций в одном месте.
- Возможность добавлять вручную новый кинематограф.
